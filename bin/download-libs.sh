...
doget fontbox 2.0.27 org/apache/pdfbox compile+runtime
doget pdfbox 2.0.27 org/apache/pdfbox compile+runtime
#für qrcode
doget core 3.5.3 com/google/zxing compile+runtime
doget javase 3.5.3 com/google/zxing compile+runtime
